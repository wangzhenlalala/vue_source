...
// _init中的 resolveConstructorOptions是如何工作的？  为什么ctor.options会被更改？？？ 如果想里面添加/删除属性，会引起他的变化吗？？？
 ...
 * 所以在
 *  resolveModifiedOptions(Ctor)中 执行的是对比当前子类的options 和 sealedOptions ，确定时候被修改，并找出差异
 ...
 * 
 *  当类的继承链上的 某一个类的options被用户手动的改变了，逻辑上来讲，该类下游的所有子类也应该随之改变。
 *  所以下游子类的 superOptions !== cachedSuperOptions 就成立，从而为该子类生成一个新的options
 * 
 */
let instance_subB = new subB({
    el: '#app',
